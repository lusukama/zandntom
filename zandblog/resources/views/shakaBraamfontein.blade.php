...
@section('content')
<div class="jumbotron card card-image" style="background-image: url(public/images/banner-shakaBraam.jpg);">
  <div class="text-white text-center py-5 px-4">
    <div class="overlay">
      <h2 class="card-title h2-responsive pt-3 mb-5 font-bold text-uppercase "><strong>African food specialist</strong></h2>
