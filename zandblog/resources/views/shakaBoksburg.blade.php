...
@section('content')
<div class="jumbotron card card-image" style="background-image: url(public/images/banner.png);">
  <div class="text-white text-center py-5 px-4">
    <div class="overlay">
      <h2 class="card-title h2-responsive pt-3 mb-5 font-bold text-uppercase  shakaBosk"><strong>Well prepared meal</strong></h2>
          ...
          <div class="col-lg-4">
            <div class="card shadow mt-5">
                <div class="justify-content-center mt-5">
                  ...
                  <p class="lead text-center mb-5"> 64 leuport street Boksburg
